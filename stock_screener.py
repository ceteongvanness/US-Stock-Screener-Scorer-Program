...
def get_all_us_stocks():
    ...
    major_tickers = [
        # S&P 500 (complete list as of 2024)
        ...
        'SNPS', 'SO', 'SOF', 'SPG', 'SPGI', 'SRE', 'STE', 'STLD', 'STT', 'STX',
        ...
        # Additional dividend aristocrats not in S&P 500
        'ABM', 'ANDE', 'ATR', 'AWR', 'BANF', 'BKH', 'BMI', 'BRC', 'CATC', 
        'CBSH', 'CBU', 'CDUAF', 'CFR', 'CTBI', 'CWT', 'DCI', 'EMLAF', 'EPD', 
        'ERIE', 'FELE', 'FMCB', 'GRC', 'LANC', 'LECO', 'LEG', 'MATW', 'MGEE', 
        'MGRC', 'MSA', 'MSEX', 'NFG', 'NJR', 'NNN', 'NWN', 'ORI', 'OZK', 
        'PB', 'PII', 'RBCAA', 'RHHVF', 'RLI', 'RNR', 'SBSI', 'SCL', 'SEIC', 
        'SJW', 'SRCE', 'TDS', 'TMP', 'TNC', 'UBSI', 'UGI', 'UMBF', 'UVV', 
        'WABC', 'WLY', 'WLYB', 'WTRG', 'YORW'
    ]
